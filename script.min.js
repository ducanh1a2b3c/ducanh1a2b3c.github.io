function changeQuote() {
    index == quotes.length && (index = 0), $("#quotes").html(quotes[index++]);
}
...
var quotes = [
        "\"Musicians play their instruments. I play the orchestra.\" - <a target='blank' href='http://www.wsj.com/articles/apple-co-founders-allies-take-aim-at-hollywood-over-steve-jobs-1444000308'>The 'opportunistic Steve Jobs movie'</a>",
...
$(document)
    .ready(function() {
        ...
        $(".down-here").click(function() {
                $("html,body").animate({ scrollTop: $(".concept-statement").offset().top + 100 },
                        e
                    ),
                    $(".down-here").hide();
            }),
            setInterval(function() {
                $(".down-here").fadeTo("fast", 0.3), $(".down-here").fadeTo("fast", 1);
            }, 1e3),
            $("h1").animate({ color: "#ffffff" }, e, function() {
                $("h3").animate({ color: "#ffffff" }, e, function() {
                    $(".socials").fadeIn(e, function() {
                        $(".concept-statement h4").fadeIn(e);
                    });
                });
            }),
            $("header").animate({ backgroundColor: "#131314" }, 0),
            $(".concept-statement").waypoint(
                function(t) {
                    "up" == t
                        ?
                        ($("h1").animate({ color: "#ffffff" }, { duration: e, queue: !1 }),
                            $("body").animate({ backgroundColor: "#131314" }, { duration: e, queue: !1 }),
                            $("h3").animate({ color: "#ffffff" }, { duration: e, queue: !1 }),
                            $("header").animate({ backgroundColor: "#131314" }, { duration: e, queue: !1 }),
                            $(".work-time").hide(),
                            $(".down-here").show()) :
                        "down" == t &&
                        ($("h1").animate({ color: "#131314" }, { duration: e, queue: !1 }),
                            $("body").animate({ backgroundColor: "#ffffff" }, { duration: e, queue: !1 }),
                            $("h3").animate({ color: "#131314" }, { duration: e, queue: !1 }),
                            $("header").animate({ backgroundColor: "#ffffff" }, { duration: e, queue: !1 }),
                            $(".work-time").show(),
                            $(".down-here").hide());
                }, {
                    offset: function() {
            ...
            $(".freelance-proj-email-field").keydown(function(e) {
                13 == e.keyCode && emailSampleHandler();
            }),
